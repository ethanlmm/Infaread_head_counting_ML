...
def MCNN():
    ...
    conv_m = keras.layers.Conv2D(40, (5, 5), padding='same',strides=1,dilation_rate=2, activation='relu')(conv_m)
    conv_m = keras.layers.MaxPooling2D(pool_size=(2, 2))(conv_m)
    ...
    conv_s = keras.layers.Conv2D(48, (3, 3), padding='same',strides=1,dilation_rate=2, activation='relu')(conv_s)
    conv_s = keras.layers.MaxPooling2D(pool_size=(2, 2))(conv_s)
    ...
    conv_l = keras.layers.Conv2D(32, (7, 7), padding='same',strides=1,dilation_rate=2, activation='relu')(conv_l)
    conv_l = keras.layers.MaxPooling2D(pool_size=(2, 2))(conv_l)
